...
\begin{titlepage}
    ...
    \begin{center}
        ...
        {\Huge\textbf{\textcolor{yolydarkblue}{The Cosmic Microwave}}\\[0.4cm]
        \Huge\textbf{\textcolor{yolydarkblue}{Background \& The}}\\[0.4cm]
        \Huge\textbf{\textcolor{yolydarkblue}{Early Universe}}}
        \end{tcolorbox}
...
\begin{tabular}{rl}
\textbf{Email:} & info@yolymaticstutorials.com \\
\textbf{Phone:} & +44 XXX XXX XXXX \\
\textbf{Location:} & United Kingdom \\
\end{tabular}
\end{tcolorbox}
